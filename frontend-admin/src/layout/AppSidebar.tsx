  ...
  const renderMenuItems = (items: NavItem[], menuType: "main" | "others") => (
    ...
    return (
      ...
      >
        ...
        <div className={`mt-auto border-t mb-5 border-[#1e507b] p-4 ${!isExpanded && !isHovered && !isMobileOpen ? 'hidden' : 'block'}`}>
          ...
          <button
            ...
            className="flex w-full cursor-pointer items-center gap-3 px-3 py-2 mt-3 font-medium bg-red-500 text-white rounded-lg group text-theme-sm transition-colors hover:bg-red-600"
          >
            <svg
