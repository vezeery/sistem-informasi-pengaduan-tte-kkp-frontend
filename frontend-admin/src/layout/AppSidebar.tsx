  ...
  return (
    ...
    >
      ...
      <div className={`mt-auto border-t mb-5 border-[#1e507b] p-4 ${!isExpanded && !isHovered && !isMobileOpen ? 'hidden' : 'block'}`}>
        ...
        <Link
          to="/signin"
          className="flex items-center gap-3 px-3 py-2 mt-3 font-medium bg-red-500 text-white rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
        >
          <svg
